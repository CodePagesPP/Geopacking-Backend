...
public interface InventarioService {
    ...
    void registrarMovimientoManual(TipoMovimiento tipoMovimiento, Double cantidad, User adminUser);
    Page<InventarioMovimientoDTO> listarMovimientos(LocalDate inicio, LocalDate fin, Pageable pageable);
